...
bash scripts/build.sh && cleos set contract wpsvt ./dist eosio.wps.wasm eosio.wps.abi

# Transfer first month budget
cleos push action volentixgsys transfer '["bob", "wpsvt", "10.00000000 VTX", "donate"]' -p bob
