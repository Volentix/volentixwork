...
# propose draft
cleos -v push action eosio.wps submitdraft '["myaccount", "mywps", "My WPS", "500.0000 VTX", 3, [{"key":"region", "value":"global"}]]' -p myaccount
cleos -v push action eosio.wps submitdraft '["toaccount", "towps", "To WPS", "200.0000 VTX", 6, [{"key":"category", "value":"other"}]]' -p toaccount
cleos -v push action eosio.wps submitdraft '["toaccount", "short", "Short WPS", "800.0000 VTX", 1, [{"key":"category", "value":"short"}]]' -p toaccount
cleos -v push action eosio.wps submitdraft '["toaccount", "novote", "No Vote WPS", "500.0000 VTX", 1, [{"key":"category", "value":"novote"}]]' -p toaccount
cleos -v push action eosio.wps submitdraft '["toaccount", "optional", "Optional Vote WPS", "500.0000 VTX", 1, [{"key":"category", "value":"optional"}]]' -p toaccount
cleos -v push action eosio.wps submitdraft '["myaccount", "large", "My WPS", "24500.0000 VTX", 1, [{"key":"category", "value":"large"}]]' -p myaccount
...
cleos -v transfer toaccount eosio.wps "400.0000 VTX" ""
